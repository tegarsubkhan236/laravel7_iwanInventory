        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Rp {{ format_uang($sub_bibit = $penjualan->jumlah*$penjualan->barang->harga_penjualan) }}</td>
                </tr>
                <tr>
                    <th>Botol</th>
                ...
                <tr>
                    <td>{{ $penjualan->botol->nama_botol }}</td>
                    <td colspan="3">Rp {{ format_uang($penjualan->botol->harga_penjualan) }}</td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
