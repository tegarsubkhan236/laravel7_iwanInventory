...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Detil Pembelian Bibit Parfum</h1>
    </div>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Data Detil pembelian Bibit Parfum</h6>
        </div>
        <div class="card-body">
        <div class="table-responsive">
            <form action="{{url('pembelian',$pembelian->id)}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="barang_id" value="{{ $pembelian->barang->nama_parfum }} " class="form-control" readonly>
                </div>
                <div class="form-group">
                    <label>Harga Pembelian</label>
                    <input type="text" name="barang_id" value="Rp.{{ format_uang($pembelian->barang->harga_pembelian) }}" class="form-control" readonly>
                </div>
                <hr>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="barang_id" value="Rp. {{  format_uang($total_pembelian = $pembelian->jumlah * $pembelian->barang->harga_pembelian) }} " class="form-control" readonly>
                </div>
